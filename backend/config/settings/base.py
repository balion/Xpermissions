...
# Bootstrap uses 'danger', Django's ERROR message tag is 'error'.
MESSAGE_TAGS = {
...
# Django 5.1+ ignores the legacy STATICFILES_STORAGE setting — storages must
# be configured via STORAGES, otherwise WhiteNoise silently doesn't apply.
STORAGES = {
    'default': {
